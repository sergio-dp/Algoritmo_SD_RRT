    ...
    def iteraciones(self, max_iter):
        ...
        for i in range(max_iter):
            ...
            if qs != qn or qs == destino: # Si la arista tiene longitud
                arbol.cablear_arbol(qs, qn, arista, mapa, r1, r2, self.elipse_actual.centro, self.elipse_actual.angulo)
...
class Arbol:
    ...
    def cablear_arbol(self, qs, qn, arista, mapa, r1, r2, elipse_centro, elipse_angulo):
        repintar_mapa = False
